...
const CONNECTOR_CONFIG: Record<ConnectorKey, ConnectorConfig> = {
  ...
  paypal: {
    ...
    products: [
      ...
      {
        id: "13fae9f4-d4a3-4208-a192-88a12c6ed76f",
        description: "-0.10 (this item)",
      },
      { id: "b013d2de-9e51-4b9c-b0c5-253e1191ba21", description: "-3% (cart)" },
      {
        id: "1e3cb950-b934-4739-aa07-ed30da6b9586",
        description: "External Tax",
      },
    ],
    countryOptions: SHARED_COUNTRY_OPTIONS,
  },
...
const BASE_CHECKOUT_APPLICATIONS: CheckoutApplication[] = [
  {
    label: "Payment only",
    applicationKey: "payment-only",
  },
  {
    label: "Complete checkout",
    applicationKey: "full-checkout",
  },
];

const CUSTOM_CHECKOUT_APPLICATION_KEY =
  import.meta.env.VITE_CTP_CUSTOM_APPLICATION_KEY ?? "";

export const CHECKOUT_APPLICATIONS = [
  ...BASE_CHECKOUT_APPLICATIONS,
  ...(CUSTOM_CHECKOUT_APPLICATION_KEY !== ""
    ? [
        {
          label: "Custom checkout",
          applicationKey: CUSTOM_CHECKOUT_APPLICATION_KEY,
        },
      ]
    : []),
];
